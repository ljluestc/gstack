...
**Output the PR/MR URL.** Then tell the user: "Your PR is ready — run `/land-and-deploy` to merge and deploy." Then proceed to Step 20.
...
- **The goal is: user says `/ship`, next thing they see is the review + PR URL + a clear prompt to run `/land-and-deploy` next.**
