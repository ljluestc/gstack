...
If verdict is DEPLOYED AND VERIFIED: Tell the user "Your changes are live and verified. Nice landing."
...
- "Need to update docs? Run `/document-release` to sync README, CHANGELOG, and other docs with what you just landed."
